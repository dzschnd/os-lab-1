...
binSearch_cmd="$exec_dir/binSearch 25000000"
ioLatRead_cmd="$exec_dir/ioLatRead $src_file 25000"
both_cmd="$exec_dir/both $src_file 25000 25000000"
both_opt_cmd="$exec_dir/bothOptimized $src_file 25000 25000000"
