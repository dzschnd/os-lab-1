...
binSearch_cmd="$exec_dir/binSearch 50000000"
ioLatRead_cmd="$exec_dir/ioLatRead $src_file 50000"
both_cmd="$exec_dir/both $src_file 50000 50000000"
both_opt_cmd="$exec_dir/bothOptimized $src_file 50000 50000000"
