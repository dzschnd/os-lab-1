...
binSearch_cmd="$exec_dir/binSearch 75000000"
ioLatRead_cmd="$exec_dir/ioLatRead $src_file 75000"
both_cmd="$exec_dir/both $src_file 75000 75000000"
both_opt_cmd="$exec_dir/bothOptimized $src_file 75000 75000000"
